...
section .data
	...
	msg2 DD "Hello World!", 0		; 0 = null character
...
main:
	push msg2		; take the data and push to the end of the stack
	push msg 		; the order is important, arguments go on in reverse
	push fmt
	call printf
	push 1
	call exit